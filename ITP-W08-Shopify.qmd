---
title: "Shopify Checkout Settings and Trust Signals Assignment"
author: "Brian V"
date: "today"
format: html
---
...
![Shopify Checkout Settings Review](images-shopify/update-policy.png)

*The screenshot above shows my review of the checkout settings in Shopify, including payment, shipping, and related configuration options.*

---

## 2. Shipping and Pickup Information
...
All orders are carefully packaged and tracked. You'll receive a tracking number via email as soon as your order ships.

### Pickup Options

Local customers can arrange in-store pickup within 2 business days of order placement at no additional cost. Please contact us to schedule your pickup time.
...
To start a return, you can contact us at brianvuong1@cpp.edu. Please note that returns will need to be sent to the following address

If your return is accepted, we’ll send you a return shipping label, as well as instructions on how and where to send your package. Items sent back to us without first requesting a return will not be accepted. 

You can always contact us for any return question at brianvuong1@cpp.edu.
...
If more than 15 business days have passed since we’ve approved your return, please contact us at brianvuong1@cpp.edu.

---

## 4. Privacy Policy and Customer Data Statement

### Privacy Policy

Last updated: July 24, 2026

Atelier North operates this store and website, including all related information, content, features, tools, products and services, in order to provide you, the customer, with a curated shopping experience (the "Services"). Atelier North is powered by Shopify, which enables us to provide the Services to you. This Privacy Policy describes how we collect, use, and disclose your personal information when you visit, use, or make a purchase or other transaction using the Services or otherwise communicate with us. If there is a conflict between our Terms of Service and this Privacy Policy, this Privacy Policy controls with respect to the collection, processing, and disclosure of your personal information.
...
The policies and store information I've implemented create multiple layers of trust that address common customer concerns in online retail. Clear shipping options with transparent pricing reduce anxiety about hidden costs, while the detailed returns policy (30-day window, prepaid labels) signals confidence in our products and reduces the perceived risk of online purchases. The privacy policy builds trust by explicitly explaining how customer data is protected and giving customers control over their information—critical factors given increasing privacy concerns. Multiple contact channels (email, phone, contact form) demonstrate accessibility and accountability, showing customers they can reach us if problems arise. Together, these elements communicate that we operate transparently, stand behind our products, and value the customer relationship beyond the single transaction.

---

## 7. CPP Farm Store Trust Signals Reflection

For the CPP Farm Store, certain trust signals become especially critical given the unique nature of agricultural retail. Transparency about product sourcing and freshness dates would be paramount—customers need assurance that produce is genuinely fresh and locally grown, not just marketed that way. A clear pickup schedule and communication about seasonal availability would build trust by setting realistic expectations. Contact information should be particularly prominent since farmers' market customers often have questions about specific items or growing practices. Additionally, certifications (organic, pesticide-free) and information about farming practices would strongly differentiate the CPP Farm Store and reassure health-conscious customers. Finally, a simple, honest return policy for perishables (acknowledging that spoilage happens) demonstrates integrity rather than hiding behind fine print—this authenticity is especially valuable for a university-affiliated farm store trying to build community relationships.